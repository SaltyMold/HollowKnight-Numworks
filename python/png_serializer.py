# https://github.com/numworks/epsilon/blob/master/ion/image/png_serializer.py
import argparse
import lz4.block
import os.path
import png
...
def generate_c_files(png_file, header_file_name, cimplementation_file_name, verbose):
    ...
    header_file.write("namespace Image {\n")
    ...
    cimplementation_file.write("namespace Image {\n")
    ...
    cimplementation_file.write(
        "extern const uint8_t compressedPixelData[" + str(compressed_data_len) + "] = {"
    )
